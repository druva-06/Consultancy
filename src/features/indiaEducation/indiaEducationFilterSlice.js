...
export const indiaEducationFilterSlice = createSlice({
  name: "indiaEducationFilter",
  initialState,
  reducers: {
...
export const {
  ...
  addSort,
  addPerPage,
} = indiaEducationFilterSlice.actions;

export default indiaEducationFilterSlice.reducer;
